		...
		<div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav nav-main">
					...
					<li class="active"><a href="/ProcesodeNutricion">Proceso de nutrición</a></li>
				...
				<div class="col-md-12">
					<div class="block">
						<div class="products-heading">
							<h2>Proceso de nutrición</h2>
						</div>	
						<div class="row">
						  	<div class="col-sm-18 col-md-12">
							    <div class="">
							    	<a href="#">
										<img src="images/digestio.jpg" height="300px" width="300px">
									</a>
						...
						<div class="panel">
							...
							<br>
						  <p>La digestión es el proceso mediante el cual los alimentos que ingerimos se descomponen en sus unidades constituyentes hasta conseguir elementos simples que seamos capaces de asimilar.</p>
						  <br>
						  <p> Como se ha visto antes, estos elementos simples son los nutrientes y podemos utilizarlos para obtener de ellos energía o para incorporarlos a nuestra propia materia viva. Los principales responsables del proceso de la digestión son las enzimas digestivas, cuya función es romper los enlaces entre los componentes de los alimentos.</p>
						  <br>
						  <p>La digestión empieza en la boca con la masticación y la insalivación. Al tiempo que el alimento se va troceando, se mezcla con la saliva hasta conseguir que esté en condiciones de pasar al estómago. La saliva contiene una enzima llamada amilasa salivar –o ptialina–, que actúa sobre los almidones y comienza a transformarlos en monosacáridos. La saliva también contiene un agente antimicrobiano –la lisozima–, que destruye parte de las bacterias contenidas en los alimentos y grandes cantidades de moco, que convierten al alimento en una masa moldeable y protegen las paredes del tubo digestivo.</p>
						  <br>
						</div>
