		...
		<div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav nav-main">
		        	<li class="active"><a href="inde">INICIO</a></li>
...
<!-- LK AQUI VAN LAS IMAGENES PARA EL SLIDER -->

	<section id="slider-area">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div id="slider" class="nivoSlider" style="height: 500px !important;">
						...
						<div class="media">
							<div class="pull-left" href="#">
						  	...
						  	<div class="media-body">
						    	<h4 class="media-heading">Universidad</h4>
						    	<p>Universidad Politécnica de Tecámac</p>
						  </div>
						</div>
					</div>
				</div>
					...
					<div class="block">
						<div class="media">
							<div class="pull-left" href="#">
						  	...
						  	<div class="media-body">
						    	<h4 class="media-heading">Alumna</h4>
						    	<p>Lisset Guadalupe Sanchez Plata</p>
						  </div>
						</div>
					</div>
				</div>
					...
					<div class="block">
						<div class="media">
							<div class="pull-left" href="#">
						  	...
						  	<div class="media-body">
						    	<h4 class="media-heading">Docente</h4>
						    	<p>Emmanuel Torres Servin</p>
				...
				<div class="col-md-12">
					<div class="block">
						<div class="products-heading">
							...
							<br>
							<p>Se llama alimentación al acto de proporcionar al cuerpo alimentos e ingerirlos. Es un proceso consciente y voluntario, y por lo tanto está en nuestras manos modificarlo. La calidad de la alimentación depende principalmente de factores económicos y culturales.</p>
							<br>
							<p>Se entiende por nutrición el conjunto de procesos fisiológicos por los cuales el organismo recibe, transforma y utiliza las sustancias químicas contenidas en los alimentos. Es un proceso involuntario e inconsciente que depende de procesos corporales como la digestión, la absorción y el transporte de los nutrientes de los alimentos hasta los tejidos.</p>
							<br>
